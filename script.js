  ...
  const script = [
    {
      ...
      output: [
        ...
        { t: 'and Accenture, currently deepening my data science and machine learning' },
        { t: 'foundations at Penn State.' },
      ],
    },
    {
      cmd: '$ git checkout -b add-ai-sentinel-compliance-platform',
      output: [{ t: "Switched to a new branch 'add-ai-sentinel-compliance-platform'", cls: 't-dim' }],
    },
    {
      cmd: '$ git commit -m "Add AI Sentinel compliance monitoring platform"',
      output: [
        { t: '[add-ai-sentinel-compliance-platform 4e9b1a0] Add AI Sentinel compliance monitoring platform', cls: 't-dim' },
        { t: ' 9 files changed, 3120 insertions(+)', cls: 't-dim' },
      ],
    },
    {
      cmd: '$ git push -u origin add-ai-sentinel-compliance-platform',
      output: [{ t: "branch set up to track 'origin/add-ai-sentinel-compliance-platform'", cls: 't-dim' }],
    },
    {
      cmd: '$ gh pr create --title "Add AI Sentinel compliance monitoring platform"',
      output: [{ t: 'https://github.com/tus2014ar/AI-Sentinel---Automated-AI-Compliance-Monitoring-Platform/pull/1', cls: 't-url' }],
    },
    {
      cmd: '$ gh pr checks 1',
